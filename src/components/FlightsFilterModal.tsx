  ...
  return (
    ...
    <ThemeProvider theme={ theme }>
      <View
        ...
        style={{ position: 'absolute', zIndex: 1000, top: 45, display: showFilterModal ? undefined : 'none' }}
      >
        <Text
          className='size-lg color-surface'
        >
        ...
        >
          <View
            className='flex-column flex-1 mr-lg'
          >
            <Text
        ...
        />
        <View
          className='flex-row mt-sm justifycontent-between'
        >
          <Button
            className='px-md'
            title={ t('buttons.clear') }
            onPress={ () => {
              setParams({ dateFrom: undefined, dateTo: undefined, airports: [] });
            }}
          />
          <Button
            ...
            onPress={ () => {
              ...
              emitter.emit('setFlightFilterState',
                params.dateFrom === undefined && params.dateTo === undefined && params.airports.length === 0 ? 'filter-outline' : 'filter'
              );
