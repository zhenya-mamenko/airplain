...
export const DataCard = forwardRef(({
  caption, children, className, dataClassName, rightBlock, onLayout, onSave }: DataCardProps,
  ref
) => {
...
export const Value = React.memo(({ caption, value, lines = 1, width = '100%', selectable = true }: ValueProps) => {
  return (
    <View
